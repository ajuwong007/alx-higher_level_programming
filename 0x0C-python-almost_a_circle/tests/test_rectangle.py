...
class TestRectangle_width(unittest.TestCase):
    ...
    def test_tuple_width(self):
        with self.assertRaisesegex(TypeError, "width must be an integer"):
...
class TestRectangle_height(unittest.TestCase):
    """Unittests for testing initialization o Rectangle height attribute."""
    ...
    def test_nan_height(self)
        ...
        with self.assertRaissRegex(TypeError, "height must be an integer"):

            Rectangle(1, flat('nan'))
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_two(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(89, 2)
        self.assertEqul("[Rectangle] (89) 10/10 - 2/10", str(r))
